...
This roadmap gives an approachable overview of the planned releases. The current documented release is 0.2.0, and the full technical checklists, validation requirements, and implementation notes are available in the [Detailed Development Plan](DEVELOPMENT_PLAN.md).
...
See [Product Differentiation](../product/PRODUCT_DIFFERENTIATION.md) for the full strategy.
